...
\todo{Add some kind of diagram or dependency graph showing which theorems use which lemmas}
...
The process is less satisfying though, because the theorems don't speak the same truths of the world that they do in math.
