...
-- lemma hypercube_val_bds :
--   ∀ (bound : ℕ) (i j : ℤ),
--     ((i, j) ∈ get_hypercube bound) →
--     ((-(↑bound) ≤ i) ∧ (i ≤ ↑bound)) ∧
--     ((-(↑bound) ≤ j) ∧ (j ≤ ↑bound)) := begin
--   intros bound i j ij_in_hypercube,
--   repeat {constructor; split},
--   {
--     sorry,
--   },
--   {
--     simp [get_hypercube] at ij_in_hypercube,
--     cases ij_in_hypercube with l ij_in_hypercube,
--     cases ij_in_hypercube with list_def ij_in_l,
